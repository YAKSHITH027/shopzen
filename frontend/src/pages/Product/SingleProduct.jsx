import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Image, Input, InputGroup, InputRightAddon, Text } from "@chakra-ui/react"
...
function SingleProduct() {
    ...
    return (
        <Box>
            <Navbar/>
        <Box m="auto" w="90%" mt="20px" mb="20px">
            {
                Loader ?
                    <LoadingSinglePage />
