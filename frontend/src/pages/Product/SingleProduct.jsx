            ...
            <Box m="auto" w="90%" mt="20px" mb="40px">
                {
                    Loader ?
                        ...
                        <Box display={["", "", "flex", "flex", "flex", "flex"]} fontFamily="sans-serif">
                            <Box w={["100%", "100%", "45%"]} backgroundColor="#F7F7F7">
                            ...
                            <Box w={["100%", "100%", "55%"]} mt={["20px", "20px", "", ""]}>
                                <Box w="85%" m="auto">
                                    <Box>
                                        ...
                                        <Box mt="20px">
                                            <InputGroup >
                                                <Input h="45px" borderRadius="0" placeholder="Enter Pincode To Check Delivery" bg="#F7F7F7" />
                                                <InputRightAddon h="45px" borderRadius="0" children="ADD" bg="#D9D9D9" />
                                            </InputGroup>
                                        </Box>
