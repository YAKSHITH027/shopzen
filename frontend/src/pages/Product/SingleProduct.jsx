...
function SingleProduct() {
  ...
  const fetchData = () => {
    setLoader(true)
    axios
      .get(`https://dark-erin-fox-cuff.cyclic.app/product/${id}`)
  ...
  const postData = () => {
    let CartProduct = {
      ...
      quantity: 1,
      discountedPrice: product.ogprice,
      price: product.price,
      image: product.image,
    }
      ...
      {Loader ? (
        ...
        >
          <Box w={['100%', '100%', '50%']} backgroundColor='#F7F7F7'>
            <Box display='flex' w='20%' h='40px' gap='7px' ml='70%' mt='5px'>
              <BsCameraVideo size='30px' /> <FiShare2 size='30px' />
          ...
          <Box w={['100%', '100%', '50%']} mt={['20px', '20px', '', '']}>
            <Box w='85%' m='auto'>
              <Box>
                ...
                <Box
                  fontSize={['15px', '15px', '16px', '16px', '18px']}
                  mt='20px'
                >
                  <Text
                    color='#E66B55'
                  ...
                  <Text display='flex' gap='4px'>
                    <AiOutlineTag />
                    BUY ANY 2 GET 10% OFF / BUY ANY 3 GET 20% OFF SITEWIDE
                  </Text>
                  <Text display='flex' gap='4px'>
                    <AiOutlineTag />
                    FREE DUFFLE BAG ON ALL ORDERS ABOVE Rs. 2499
                  </Text>
                </Box>
